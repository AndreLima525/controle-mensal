...
var Fx = /** @class */ (function () {
    ...
    Fx.prototype.update = function () {
        ...
        now = (_a = this.now) !== null && _a !== void 0 ? _a : 1, step = this.options.step;
    ...
    Fx.prototype.run = function (from, to, unit) {
        var _this = this;
        var _a = this, elem = _a.elem, options = _a.options, complete = options.complete, _b = options.curAnim, curAnim = _b === void 0 ? {} : _b, timer = function (gotoEnd) {
