...
function checkClearPoint(series, x, y, bBox, checkDistance) {
    var _a;
    var chart = series.chart, seriesLabelOptions = series.options.label || {}, onArea = ((_a = seriesLabelOptions.onArea) !== null && _a !== void 0 ? _a : !!series.area), findDistanceToOthers = (onArea || seriesLabelOptions.connectorAllowed), leastDistance = 16, boxesToAvoid = chart.boxesToAvoid;
...
function drawSeriesLabels(chart) {
    ...
    chart.series.forEach(function (series) {
        ...
        function insidePane(x, y, bBox) {
            var leftBound = Math.max(paneLeft, (areaMin !== null && areaMin !== void 0 ? areaMin : -Infinity)), rightBound = Math.min(paneLeft + paneWidth, (areaMax !== null && areaMax !== void 0 ? areaMax : Infinity));
            return (x > leftBound &&
...
function getPointsOnGraph(series) {
    ...
    if (series.getPointSpline &&
        ...
        var last = void 0;
        for (i = 0; i < len; i += 1) {
            var point = points[i], _e = point.pos() || [], plotX = _e[0], plotY = _e[1], plotHigh = point.plotHigh;
