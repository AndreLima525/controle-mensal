...
var SVGLabel = /** @class */ (function (_super) {
    ...
    SVGLabel.prototype.getBBox = function (reload, rot) {
        ...
        var _b = this, padding = _b.padding, _c = _b.height, height = _c === void 0 ? 0 : _c, _d = _b.translateX, translateX = _d === void 0 ? 0 : _d, _e = _b.translateY, translateY = _e === void 0 ? 0 : _e, _f = _b.width, width = _f === void 0 ? 0 : _f, paddingLeft = ((_a = this.paddingLeft) !== null && _a !== void 0 ? _a : padding), rotation = rot !== null && rot !== void 0 ? rot : (this.rotation || 0);
        var bBox = {
            width: width,
            height: height,
