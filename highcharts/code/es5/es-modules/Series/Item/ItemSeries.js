    ...
    ItemSeries.prototype.drawPoints = function () {
        ...
        for (var _i = 0, _b = series.points; _i < _b.length; _i++) {
            ...
            var pointMarkerOptions = point.marker || {}, symbol = (pointMarkerOptions.symbol ||
                seriesMarkerOptions.symbol), r = ((_a = pointMarkerOptions.radius) !== null && _a !== void 0 ? _a : seriesMarkerOptions.radius), size = defined(r) ? 2 * r : itemSize, padding = size * options.itemPadding;
