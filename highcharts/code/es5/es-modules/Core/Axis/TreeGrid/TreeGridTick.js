...
function wrapGetLabelPosition(proceed, x, y, label, horiz, labelOptions, tickmarkOffset, index, step) {
    var _a, _b;
    var tick = this, lbOptions = ((_b = (_a = tick.options) === null || _a === void 0 ? void 0 : _a.labels) !== null && _b !== void 0 ? _b : labelOptions), pos = tick.pos, axis = tick.axis, isTreeGrid = axis.type === 'treegrid', result = proceed.apply(tick, [x, y, label, horiz, lbOptions, tickmarkOffset, index, step]);
    var mapOfPosToGridNode, node, level;
    if (isTreeGrid) {
        var _c = (lbOptions && isObject(lbOptions.symbol, true) ?
            lbOptions.symbol :
            {}), _d = _c.width, width = _d === void 0 ? 0 : _d, _e = _c.padding, padding = _e === void 0 ? axis.linkedParent ? 0 : 5 : _e, indentation = (lbOptions && isNumber(lbOptions.indentation) ?
