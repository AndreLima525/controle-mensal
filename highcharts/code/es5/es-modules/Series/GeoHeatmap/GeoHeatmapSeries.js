...
var GeoHeatmapSeries = /** @class */ (function (_super) {
    ...
    GeoHeatmapSeries.prototype.drawPoints = function () {
        ...
        if (series.getInterpolation().enabled && mapView && series.bounds) {
            var ctx = series.context || getContext(series), canvas = series.canvas, colorAxis = series.colorAxis, image_1 = series.image, chart_1 = series.chart, points = series.points, _c = [
                ((_a = seriesOptions.colsize) !== null && _a !== void 0 ? _a : 1),
                ((_b = seriesOptions.rowsize) !== null && _b !== void 0 ? _b : 1)
            ], colsize_1 = _c[0], rowsize_1 = _c[1], 
            ...
            if (canvas && ctx && colorAxis && topLeft && bottomRight) {
                ...
                series.isDirtyCanvas ||
                    ...
                    for (var i = 0; i < pointsLen; i++) {
                        var p = points[i], _g = p.options, lon_1 = _g.lon, lat_1 = _g.lat;
