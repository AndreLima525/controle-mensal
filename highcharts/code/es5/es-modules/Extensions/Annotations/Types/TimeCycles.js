...
var TimeCycles = /** @class */ (function (_super) {
    ...
    TimeCycles.prototype.setPathProperties = function () {
        ...
        var point1 = points[0], point2 = points[1], xAxis = getAxisFromOptions(this.chart, 'xAxis', (_a = options.xAxis) !== null && _a !== void 0 ? _a : 0), yAxis = getAxisFromOptions(this.chart, 'yAxis', (_b = options.yAxis) !== null && _b !== void 0 ? _b : 0), xValue1 = point1.x, yValue = point1.y, xValue2 = point2.x;
