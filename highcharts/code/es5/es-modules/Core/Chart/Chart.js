...
var Chart = /** @class */ (function () {
    ...
    Chart.prototype.redraw = function (animation) {
        ...
        var hasDirtyStacks, hasStackedSeries, i, redrawLegend = chart.isDirtyLegend, serie;
    ...
    Chart.prototype.getContainer = function () {
         ...
         */
        chart.renderer = new SVGRenderer(container, chartWidth, chartHeight, void 0, optionsChart.forExport, (_c = options.exporting) === null || _c === void 0 ? void 0 : _c.allowHTML, chart.styledMode, options.palette, chart.index);
    ...
    Chart.prototype.render = function () {
        var _a, _b, _c, _d;
        var chart = this, axes = chart.axes, colorAxis = chart.colorAxis, renderer = chart.renderer, _e = chart.options.chart, _f = _e.axisLayoutRuns, axisLayoutRuns = _f === void 0 ? 2 : _f, plotBorderRadius = _e.plotBorderRadius, renderAxes = function (axes) {
            axes.forEach(function (axis) {
                if (axis.visible) {
                    axis.render();
                }
        ...
        while ((redoHorizontal || redoVertical || axisLayoutRuns > 1) &&
            ...
            for (var _g = 0, axes_2 = axes; _g < axes_2.length; _g++) {
                var axis = axes_2[_g];
                ...
                if (run === 0) {
                    ...
                    var tickIntervalMatch = (_d = (_c = axis.tickPositions) === null || _c === void 0 ? void 0 : _c.info) === null || _d === void 0 ? void 0 : _d.match;
    ...
    Chart.prototype.showLoading = function (str) {
        ...
        // Update text
        AST.setElementHTML(loadingSpan, ((_b = str !== null && str !== void 0 ? str : options.lang.loading) !== null && _b !== void 0 ? _b : ''));
        if (!chart.styledMode) {
            // Update visuals
    ...
    Chart.prototype.transform = function (params) {
        ...
        var _this = this;
        var _b, _c, _d, _e, _f;
        var _g = params.axes, axes = _g === void 0 ? this.axes : _g, event = params.event, _h = params.from, from = _h === void 0 ? {} : _h, reset = params.reset, selection = params.selection, _j = params.to, to = _j === void 0 ? {} : _j, trigger = params.trigger, _k = params.allowResetButton, allowResetButton = _k === void 0 ? true : _k, time = this.time;
