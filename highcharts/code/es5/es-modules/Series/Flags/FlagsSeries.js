...
var FlagsSeries = /** @class */ (function (_super) {
    ...
    FlagsSeries.prototype.pointAttribs = function (point, state) {
        ...
        var options = this.options, color = (point === null || point === void 0 ? void 0 : point.color) || this.color;
        var lineColor = options.lineColor, lineWidth = point === null || point === void 0 ? void 0 : point.lineWidth, fill = (point === null || point === void 0 ? void 0 : point.fillColor) || options.fillColor;
        if (state) {
