...
function onSeriesAfterColumnTranslate() {
    ...
    if (options.borderRadius &&
        chart.polar &&
        chart.inverted) {
        var seriesDefault = (_c = (_b = defaultOptions.plotOptions) === null || _b === void 0 ? void 0 : _b[this.type]) === null || _c === void 0 ? void 0 : _c.borderRadius, _e = borderRadiusObject(options.borderRadius, isObject(seriesDefault) ? seriesDefault : {}), scope = _e.scope, _f = _e.where, where = _f === void 0 ? 'end' : _f;
...
function wrapColumnSeriesAlignDataLabel(proceed, point, dataLabel, options, alignTo, isNew) {
    var _a, _b, _c;
    var chart = this.chart, inside = ((_a = options.inside) !== null && _a !== void 0 ? _a : !!this.options.stacking);
...
function onAfterColumnTranslate() {
    var series = this, chart = series.chart, options = series.options, xAxis = series.xAxis, yAxis = series.yAxis, stacking = options.stacking, center = yAxis.center, reversed = yAxis.reversed, endAngleRad = xAxis.endAngleRad, startAngleRad = xAxis.startAngleRad, visibleRange = endAngleRad - startAngleRad;
    ...
    if (xAxis.isRadial) {
        ...
        while (i--) {
            ...
            if (chart.inverted) {
                ...
                var brOption = borderRadiusObject(options.borderRadius), borderRadius = relativeLength(brOption.radius, r - innerR);
                point.shapeArgs = {
                    x: center[0],
                    y: center[1],
                    r: r,
...
var PolarAdditions = /** @class */ (function () {
    ...
    PolarAdditions.prototype.arc = function (low, high, start, end) {
        ...
        var r = len - high + paneInnerR, innerR = len - (low !== null && low !== void 0 ? low : len) + paneInnerR;
