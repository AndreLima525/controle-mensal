...
var VariablePieSeries = /** @class */ (function (_super) {
    ...
    VariablePieSeries.prototype.calculateExtremes = function () {
        ...
        if (zData.length) {
            zMin =
                (_a = seriesOptions.zMin) !== null && _a !== void 0 ? _a : arrayMin(zData.filter(series.zValEval));
            zMax =
                (_b = seriesOptions.zMax) !== null && _b !== void 0 ? _b : arrayMax(zData.filter(series.zValEval));
