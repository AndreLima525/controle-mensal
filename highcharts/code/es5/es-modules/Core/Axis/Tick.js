...
var Tick = /** @class */ (function () {
    ...
    Tick.prototype.addLabel = function () {
        ...
        var tick = this, axis = tick.axis, options = axis.options, chart = axis.chart, categories = axis.categories, log = axis.logarithmic, names = axis.names, pos = tick.pos, labelOptions = ((_b = (_a = tick.options) === null || _a === void 0 ? void 0 : _a.labels) !== null && _b !== void 0 ? _b : options.labels), tickPositions = axis.tickPositions, isFirst = pos === tickPositions[0], isLast = pos === tickPositions[tickPositions.length - 1], tickPositionInfo = tickPositions.info, boundary = tickPositionInfo === null || tickPositionInfo === void 0 ? void 0 : tickPositionInfo.boundaryTicks[pos], DTLFormats = options.dateTimeLabelFormats;
        ...
        if (axis.dateTime && DTLFormats) {
            if (tickPositionInfo) {
                ...
                var unitName = tickPositionInfo.unitName, boundaryKey = boundariesMap[unitName], format = !((_e = options.grid) === null || _e === void 0 ? void 0 : _e.enabled) &&
                    boundary &&
                    boundaryKey &&
    ...
    Tick.prototype.getLabelPosition = function (x, y, label, horiz, labelOptions, tickmarkOffset, index, step) {
        ...
        x = x +
            ((_a = labelOptions.x) !== null && _a !== void 0 ? _a : [0, 1, 0, -1][axis.side] * distance) +
    ...
    Tick.prototype.render = function (index, old, opacity) {
        var _a, _b, _c;
        var tick = this, axis = tick.axis, horiz = axis.horiz, pos = tick.pos, tickmarkOffset = ((_a = tick.tickmarkOffset) !== null && _a !== void 0 ? _a : axis.tickmarkOffset), xy = tick.getPosition(horiz, pos, tickmarkOffset, old), x = xy.x, y = xy.y, axisStart = axis.pos, axisEnd = axisStart + axis.len, pxPos = horiz ? x : y;
        var labelOpacity = ((_c = opacity !== null && opacity !== void 0 ? opacity : (_b = tick.label) === null || _b === void 0 ? void 0 : _b.newOpacity) !== null && _c !== void 0 ? _c : 1);
    ...
    Tick.prototype.renderGridLine = function (old, opacity) {
        var _a;
        var tick = this, axis = tick.axis, options = axis.options, attribs = {}, pos = tick.pos, type = tick.type, tickmarkOffset = ((_a = tick.tickmarkOffset) !== null && _a !== void 0 ? _a : axis.tickmarkOffset), renderer = axis.chart.renderer;
    ...
    Tick.prototype.renderMark = function (xy, opacity) {
        var _a;
        var tick = this, axis = tick.axis, options = axis.options, renderer = axis.chart.renderer, type = tick.type, tickSize = axis.tickSize(type ? type + 'Tick' : 'tick'), x = xy.x, y = xy.y, tickWidth = (_a = options[type !== 'minor' ? 'tickWidth' : 'minorTickWidth']) !== null && _a !== void 0 ? _a : (!type && axis.isXAxis ? 1 : 0), // X axis defaults to 1
    ...
    Tick.prototype.renderLabel = function (xy, old, opacity, index) {
        var _a;
        var tick = this, axis = tick.axis, horiz = axis.horiz, options = axis.options, label = tick.label, labelOptions = options.labels, step = labelOptions.step, tickmarkOffset = ((_a = tick.tickmarkOffset) !== null && _a !== void 0 ? _a : axis.tickmarkOffset), x = xy.x, y = xy.y;
        var show = true;
        if (label && isNumber(x)) {
