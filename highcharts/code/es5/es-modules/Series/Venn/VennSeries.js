...
var VennSeries = /** @class */ (function (_super) {
    ...
    VennSeries.prototype.pointAttribs = function (point, state) {
        var _a;
        var series = this, seriesOptions = series.options || {}, pointOptions = (point === null || point === void 0 ? void 0 : point.options) || {}, stateOptions = (state && ((_a = seriesOptions.states) === null || _a === void 0 ? void 0 : _a[state])) || {}, options = merge(seriesOptions, pointOptions, stateOptions);
