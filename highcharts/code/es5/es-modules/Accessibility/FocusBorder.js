...
(function (FocusBorderComposition) {
    ...
    function svgElementAddFocusBorder(margin, attribs) {
        ...
        // Add the border rect
        var bb = this.getBBox(), pad = (margin !== null && margin !== void 0 ? margin : 3), parent = this.parentGroup, scaleX = this.scaleX || parent && parent.scaleX, scaleY = this.scaleY || parent && parent.scaleY, oneDefined = scaleX ? !scaleY : scaleY, scaleBoth = oneDefined ? Math.abs(scaleX || scaleY || 1) :
