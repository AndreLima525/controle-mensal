...
var BubbleLegendItem = /** @class */ (function () {
    ...
    BubbleLegendItem.prototype.drawLegendSymbol = function (legend) {
        var _a;
        var itemDistance = ((_a = legend.options.itemDistance) !== null && _a !== void 0 ? _a : 20), legendItem = this.legendItem || {}, options = this.options, ranges = options.ranges, connectorDistance = options.connectorDistance;
        var connectorSpace;
    ...
    BubbleLegendItem.prototype.getRanges = function () {
        ...
        series.forEach(function (s) {
            ...
            if (s.isBubble && !s.ignoreSeries) {
                ...
                if (zData.length) {
                    minZ = ((_a = s.options.zMin) !== null && _a !== void 0 ? _a : Math.min(minZ, Math.max(arrayMin(zData), s.options.displayNegative === false ?
                        s.options.zThreshold :
                        -Number.MAX_VALUE)));
                    maxZ = ((_b = s.options.zMax) !== null && _b !== void 0 ? _b : Math.max(maxZ, arrayMax(zData)));
                }
            }
        });
