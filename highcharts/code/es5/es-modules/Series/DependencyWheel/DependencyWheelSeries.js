...
var DependencyWheelSeries = /** @class */ (function (_super) {
    ...
    DependencyWheelSeries.prototype.translateLink = function (point) {
        var linkToHeight = Math.max((point.weightTo || point.weight || 0) * this.translationFactor, this.options.minLinkWidth || 0);
        var linkToY = this.getY(point, point.toNode, 'linksTo', linkToHeight);
        // Translate the link
