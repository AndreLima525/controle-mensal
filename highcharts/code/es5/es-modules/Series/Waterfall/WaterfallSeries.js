...
addEvent(WaterfallSeries, 'afterColumnTranslate', function () {
    var _a, _b;
    var _c, _d, _e;
    var series = this, options = series.options, points = series.points, yAxis = series.yAxis, minPointLength = ((_c = options.minPointLength) !== null && _c !== void 0 ? _c : 5), halfMinPointLength = minPointLength / 2, threshold = options.threshold || 0, stacking = options.stacking, actualStack = (_d = yAxis.waterfall) === null || _d === void 0 ? void 0 : _d.stacks[series.stackKey], processedYData = series.getColumn('y', true);
