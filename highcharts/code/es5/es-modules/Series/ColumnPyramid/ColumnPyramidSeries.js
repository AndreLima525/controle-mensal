...
var ColumnPyramidSeries = /** @class */ (function (_super) {
    ...
    ColumnPyramidSeries.prototype.translate = function () {
        ...
        var series = this, chart = series.chart, options = series.options, dense = series.dense =
            ...
            (_a = options.borderWidth) !== null && _a !== void 0 ? _a : (dense ? 0 : 1), yAxis = series.yAxis, threshold = options.threshold, minPointLength = ((_b = options.minPointLength) !== null && _b !== void 0 ? _b : 5), metrics = series.getColumnMetrics(), pointWidth = metrics.width, pointXOffset = series.pointXOffset = metrics.offset;
        ...
        for (var _i = 0, _d = series.points; _i < _d.length; _i++) {
            var point = _d[_i];
            var yBottom = ((_c = point.yBottom) !== null && _c !== void 0 ? _c : translatedThreshold), safeDistance = 999 + Math.abs(yBottom), plotY = clamp(point.plotY, -safeDistance, yAxis.len + safeDistance), 
