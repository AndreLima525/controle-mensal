...
var column = {
    ...
    y: {
        ...
        beforeResize: function (guideBox, pointVals, point) {
            ...
            var plotThreshold = (_a = point.yBottom) !== null && _a !== void 0 ? _a : point.series.translatedThreshold, plotY = guideBox.attr('y'), threshold = isNumber(point.stackY) ? (point.stackY - (point.y || 0)) : point.series.options.threshold || 0, y = threshold + pointVals.y;
            var height, diff;
