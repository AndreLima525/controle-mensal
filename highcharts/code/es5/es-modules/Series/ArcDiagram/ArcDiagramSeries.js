...
var ArcDiagramSeries = /** @class */ (function (_super) {
    ...
    ArcDiagramSeries.prototype.translateLink = function (point) {
        var _a, _b;
        var _c, _d, _e;
        var series = this, fromNode = point.fromNode, toNode = point.toNode, chart = this.chart, translationFactor = series.translationFactor, pointOptions = point.options, seriesOptions = series.options, linkWeight = ((_d = (_c = pointOptions.linkWeight) !== null && _c !== void 0 ? _c : seriesOptions.linkWeight) !== null && _d !== void 0 ? _d : Math.max((point.weight || 0) *
            translationFactor *
    ...
    ArcDiagramSeries.prototype.translateNode = function (node, column) {
        ...
        var series = this, translationFactor = series.translationFactor, chart = series.chart, maxNodesLength = chart.inverted ?
            ...
            (nodeOffset && nodeOffset.relativeLeft || 0))), lineWidth), markerOptions = merge(options.marker, node.options.marker), symbol = markerOptions.symbol, markerRadius = markerOptions.radius, top = parseInt((_c = options.offset) !== null && _c !== void 0 ? _c : '100', 10) *
            ((chart.inverted ?
