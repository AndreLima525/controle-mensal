    ...
    DotPlotSeries.prototype.drawPoints = function () {
        ...
        for (var _i = 0, _e = series.points; _i < _e.length; _i++) {
            ...
            var pointMarkerOptions = point.marker || {}, symbol = (pointMarkerOptions.symbol ||
                seriesMarkerOptions.symbol), radius = (_c = pointMarkerOptions.radius) !== null && _c !== void 0 ? _c : seriesMarkerOptions.radius, isSquare = symbol !== 'rect', width = isSquare ? height : slotWidth, shapeArgs = point.shapeArgs || {}, startX = (shapeArgs.x || 0) + ((shapeArgs.width || 0) -
                slotsPerBar * width) / 2, positiveYValue = Math.abs((_d = point.y) !== null && _d !== void 0 ? _d : 0), shapeY = (shapeArgs.y || 0), shapeHeight = (shapeArgs.height || 0);
