...
var ColorAxis = /** @class */ (function (_super) {
    ...
    ColorAxis.prototype.drawLegendSymbol = function (legend, item) {
        ...
        var axis = this, legendItem = item.legendItem || {}, padding = legend.padding, legendOptions = legend.options, labelOptions = axis.options.labels, itemDistance = ((_a = legendOptions.itemDistance) !== null && _a !== void 0 ? _a : 10), horiz = axis.horiz, _h = axis.getSize(), width = _h.width, height = _h.height, labelPadding = (_b = legendOptions.labelPadding) !== null && _b !== void 0 ? _b : (horiz ? 16 : 30);
        this.setLegendColor();
        var titleHeight = 0;
        var titleWidth = 0;
    ...
    ColorAxis.prototype.drawCrosshair = function (e, point) {
        var axis = this, legendItem = axis.legendItem || {}, plotX = point === null || point === void 0 ? void 0 : point.plotX, plotY = point === null || point === void 0 ? void 0 : point.plotY, axisPos = axis.pos, axisLen = axis.len, markerOptions = axis.options.marker || {};
        var crossPos;
        if (point) {
    ...
    ColorAxis.prototype.getPlotLinePath = function (options) {
        var axis = this, left = axis.left, pos = options.translatedValue, symbol = (this.options.marker || {}).symbol, top = axis.top;
        // Crosshairs only
        if (isNumber(pos)) {
            if (symbol) {
                var w = axis.height, x = pos - w / 2, y = top;
                if (!axis.horiz) {
                    w = axis.width;
                    x = left;
                    y = pos - w / 2;
    ...
    ColorAxis.prototype.getDataClassLegendSymbols = function () {
        ...
        var axis = this, chart = axis.chart, legendItems = (axis.legendItem &&
            ...
            []), legendOptions = chart.options.legend, valueDecimals = ((_a = legendOptions.valueDecimals) !== null && _a !== void 0 ? _a : -1), valueSuffix = ((_b = legendOptions.valueSuffix) !== null && _b !== void 0 ? _b : '');
    ...
    ColorAxis.prototype.getSize = function () {
        var _a, _b;
        var axis = this, chart = axis.chart, horiz = axis.horiz, _c = axis.options, colorAxisHeight = _c.height, colorAxisWidth = _c.width, legendOptions = chart.options.legend, width = defined(colorAxisWidth) ?
            relativeLength(colorAxisWidth, chart.chartWidth) :
            ((_a = legendOptions === null || legendOptions === void 0 ? void 0 : legendOptions.symbolWidth) !== null && _a !== void 0 ? _a : (horiz ? ColorAxis.defaultLegendLength : 12)), height = defined(colorAxisHeight) ?
