...
var VerticalLine = /** @class */ (function (_super) {
    ...
    VerticalLine.connectorFirstPoint = function (target) {
        ...
        var annotation = target.annotation, chart = annotation.chart, inverted = chart.inverted, point = annotation.points[0], left = ((_b = (_a = point.series.yAxis) === null || _a === void 0 ? void 0 : _a.left) !== null && _b !== void 0 ? _b : 0), top = ((_d = (_c = point.series.yAxis) === null || _c === void 0 ? void 0 : _c.top) !== null && _d !== void 0 ? _d : 0), offset = ((_f = (_e = annotation.options.typeOptions) === null || _e === void 0 ? void 0 : _e.label) === null || _f === void 0 ? void 0 : _f.offset) || 0, y = MockPoint.pointToPixels(point, true)[inverted ? 'x' : 'y'];
        return {
            x: point.x,
    ...
    VerticalLine.connectorSecondPoint = function (target) {
        var _a, _b, _c;
        var annotation = target.annotation, chart = annotation.chart, inverted = chart.inverted, typeOptions = annotation.options.typeOptions, point = annotation.points[0], left = ((_a = (point.series.yAxis && point.series.yAxis.left)) !== null && _a !== void 0 ? _a : 0), top = ((_b = (point.series.yAxis && point.series.yAxis.top)) !== null && _b !== void 0 ? _b : 0), y = MockPoint.pointToPixels(point, true)[inverted ? 'x' : 'y'];
