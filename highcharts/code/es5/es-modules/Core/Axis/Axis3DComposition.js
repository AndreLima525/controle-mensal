...
var Axis3DAdditions = /** @class */ (function () {
    ...
    Axis3DAdditions.prototype.fix3dPosition = function (pos, isTitle) {
        ...
        var alpha = deg2rad * chart.options.chart.options3d.alpha, beta = deg2rad * chart.options.chart.options3d.beta, positionMode = ((_a = (isTitle && axis.options.title.position3d)) !== null && _a !== void 0 ? _a : axis.options.labels.position3d), skew = ((_b = (isTitle && axis.options.title.skew3d)) !== null && _b !== void 0 ? _b : axis.options.labels.skew3d), frame = chart.chart3d.frame3d, plotLeft = chart.plotLeft, plotRight = chart.plotWidth + plotLeft, plotTop = chart.plotTop, plotBottom = chart.plotHeight + plotTop;
