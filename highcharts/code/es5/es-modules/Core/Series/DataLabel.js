    ...
    function alignDataLabel(point, dataLabel, options, alignTo, isNew) {
        ...
        if (pos) {
            ...
            if (justify && visible && alignTo.height >= 0) { // #8830
                ...
                var _f = dataLabel.alignAttr, x_1 = _f.x, y_1 = _f.y, correction = 1;
            ...
            points.concat(series.condemnedPoints).forEach(function (point) {
                ...
                pointOptions.forEach(function (labelOptions, i) {
                    ...
                    var labelEnabled = (labelOptions.enabled &&
                        ...
                        applyFilter(point, labelOptions)), backgroundColor = labelOptions.backgroundColor, borderColor = labelOptions.borderColor, distance = labelOptions.distance, _g = labelOptions.style, style = _g === void 0 ? {} : _g, padding = splat(labelOptions.padding || 0);
