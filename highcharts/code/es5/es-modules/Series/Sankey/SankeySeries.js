...
var SankeySeries = /** @class */ (function (_super) {
    ...
    SankeySeries.prototype.getY = function (point, node, fromOrTo, linkHeight) {
        var linkTop = (node.offset(point, fromOrTo) || 0) * this.translationFactor;
    ...
    SankeySeries.prototype.translateLink = function (point, linkToY) {
        var _a;
        var fromNode = point.fromNode, toNode = point.toNode, chart = this.chart, inverted = chart.inverted, translationFactor = this.translationFactor, options = this.options, linkColorMode = ((_a = point.linkColorMode) !== null && _a !== void 0 ? _a : options.linkColorMode), curvy = ((chart.inverted ? -this.colDistance : this.colDistance) *
    ...
    SankeySeries.prototype.translateNode = function (node, column) {
        var _a;
        var translationFactor = this.translationFactor, chart = this.chart, options = this.options, borderRadius = options.borderRadius, _b = options.borderWidth, borderWidth = _b === void 0 ? 0 : _b, sum = node.getSum(), nodeHeight = Math.max(Math.round(sum * translationFactor), this.options.minLinkWidth), nodeWidth = Math.round(this.nodeWidth), nodeOffset = column.sankeyColumn.offset(node, translationFactor), fromNodeTop = crisp(((_a = nodeOffset.absoluteTop) !== null && _a !== void 0 ? _a : (column.sankeyColumn.top(translationFactor) +
        ...
        if (sum) {
            ...
            // #18956
            var r = clamp(relativeLength((isObject(borderRadius) ?
                borderRadius.radius :
