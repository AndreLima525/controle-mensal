...
var BubbleSeries = /** @class */ (function (_super) {
    ...
    BubbleSeries.prototype.getPxExtremes = function () {
        ...
        // always visible. #5873
        var maxPxSize = Math.max(getPxSize((_b = this.options.maxSize) !== null && _b !== void 0 ? _b : '20%'), minPxSize);
    ...
    BubbleSeries.prototype.getZExtremes = function () {
        ...
        if (zData.length) {
            var zMin = ((_a = options.zMin) !== null && _a !== void 0 ? _a : clamp(arrayMin(zData), options.displayNegative === false ?
                (options.zThreshold || 0) :
                -Number.MAX_VALUE, Number.MAX_VALUE));
            var zMax = ((_b = options.zMax) !== null && _b !== void 0 ? _b : arrayMax(zData));
