    ...
    MapPoint.prototype.getProjectedBounds = function (projection) {
        ...
        if (bounds) {
            ...
            if (mapView && isNumber(propMiddleLon) && isNumber(propMiddleLat)) {
                ...
                bounds.midX = (bounds.x1 + (bounds.x2 - bounds.x1) * ((_a = this.middleX) !== null && _a !== void 0 ? _a : (isNumber(propMiddleX) ? propMiddleX : 0.5)));
                var middleYFraction = (_b = this.middleY) !== null && _b !== void 0 ? _b : (isNumber(propMiddleY) ? propMiddleY : 0.5);
