...
var MapSeries = /** @class */ (function (_super) {
    ...
    MapSeries.prototype.drawPoints = function () {
                ...
                if (graphic) {
                    ...
                    graphic.animate = function (params, options, complete) {
                        ...
                        if (animateIn || animateOut) {
                            var strokeWidth = (_a = series.getStrokeWidth(series.options)) !== null && _a !== void 0 ? _a : 1, inheritedStrokeWidth = (strokeWidth /
        ...
        transformGroups.forEach(function (transformGroup, i) {
            var _a;
            var view = i === 0 ? mapView : mapView.insets[i - 1], svgTransform = view.getSVGTransform(), strokeWidth = ((_a = _this.getStrokeWidth(_this.options)) !== null && _a !== void 0 ? _a : 1);
            /*
