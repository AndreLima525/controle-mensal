...
var FlowMapSeries = /** @class */ (function (_super) {
    ...
    FlowMapSeries.prototype.getPointShapeArgs = function (point) {
        ...
        var finalWidth = this.getLinkWidth(point) / 2, pointOptions = point.options, markerEndOptions = merge(this.options.markerEnd, pointOptions.markerEnd), growTowards = (_b = pointOptions.growTowards) !== null && _b !== void 0 ? _b : this.options.growTowards, fromX = fromPos.x || 0, fromY = fromPos.y || 0;
        var toX = toPos.x || 0, toY = toPos.y || 0, curveFactor = (_c = pointOptions.curveFactor) !== null && _c !== void 0 ? _c : this.options.curveFactor, offset = markerEndOptions && markerEndOptions.enabled &&
        ...
        if (offset) {
            ...
            var _d = FlowMapSeries.normalize(arcPointX_1 - toX, arcPointY_1 - toY), offsetX = _d[0], offsetY = _d[1];
            offsetX *= offset;
            offsetY *= offset;
            toX += offsetX;
            toY += offsetY;
        ...
        var _e = FlowMapSeries.normalize(dX, dY), wX = _e[0], wY = _e[1];
        ...
        var _f = FlowMapSeries.normalize(arcPointX - fromX, arcPointY - fromY), fromXToArc = _f[0], fromYToArc = _f[1];
        tmp = fromXToArc;
        ...
        var _g = FlowMapSeries.normalize(arcPointX - toX, arcPointY - toY), toXToArc = _g[0], toYToArc = _g[1];
        tmp = toXToArc;
        toXToArc = -toYToArc;
        toYToArc = tmp;
        toXToArc *= finalWidth;
