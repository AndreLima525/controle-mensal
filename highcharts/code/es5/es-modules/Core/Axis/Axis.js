...
var Axis = /** @class */ (function () {
    ...
    Axis.prototype.init = function (chart, userOptions, coll) {
         ...
         * @type {number}
         */
        axis.side = ((_c = (_b = userOptions.side) !== null && _b !== void 0 ? _b : axis.side) !== null && _c !== void 0 ? _c : (horiz ?
        ...
        (_d = axis.type) !== null && _d !== void 0 ? _d : (axis.type = options.type || 'linear');
        (_e = axis.uniqueNames) !== null && _e !== void 0 ? _e : (axis.uniqueNames = (_f = options.uniqueNames) !== null && _f !== void 0 ? _f : true);
         ...
         * @type {boolean}
         */
        axis.reversed = ((_g = options.reversed) !== null && _g !== void 0 ? _g : axis.reversed);
         ...
         * @type {number}
         */
        (_h = axis.len) !== null && _h !== void 0 ? _h : (axis.len = 0);
         ...
         */
        var crosshair = (_j = options.crosshair) !== null && _j !== void 0 ? _j : splat(chart.options.tooltip.crosshairs)[isXAxis ? 0 : 1];
    ...
    Axis.prototype.setTickInterval = function (secondPass) {
        ...
        hardMin = ((_b = axis.userMin) !== null && _b !== void 0 ? _b : time.parse(options.min));
        hardMax = ((_c = axis.userMax) !== null && _c !== void 0 ? _c : time.parse(options.max));
        // Linked axis gets the extremes from the parent axis
        if (linkedParent) {
            axis.linkedParent = linkedParent;
            linkedParentExtremes = linkedParent.getExtremes();
            axis.min =
                (_d = linkedParentExtremes.min) !== null && _d !== void 0 ? _d : linkedParentExtremes.dataMin;
            axis.max =
                (_e = linkedParentExtremes.max) !== null && _e !== void 0 ? _e : linkedParentExtremes.dataMax;
            ...
            axis.min = ((_f = hardMin !== null && hardMin !== void 0 ? hardMin : thresholdMin) !== null && _f !== void 0 ? _f : dataMin);
            axis.max = ((_g = hardMax !== null && hardMax !== void 0 ? hardMax : thresholdMax) !== null && _g !== void 0 ? _g : dataMax);
        }
        ...
        if (isNumber(axis.min) && isNumber(axis.max)) {
            ...
            if (!categories &&
                !axis.axisPointRange &&
                !((_h = axis.stacking) === null || _h === void 0 ? void 0 : _h.usePercentage) &&
                !linkedParent) {
        ...
        if (isXAxis && !secondPass) {
            var hasExtremesChanged_1 = axis.min !== ((_j = axis.old) === null || _j === void 0 ? void 0 : _j.min) ||
                axis.max !== ((_k = axis.old) === null || _k === void 0 ? void 0 : _k.max);
        ...
        var minTickInterval = (_l = options.minTickInterval) !== null && _l !== void 0 ? _l : (dateTime && !axis.series.some(function (s) { return !s.sorted; }) ?
    ...
    Axis.prototype.setAxisSize = function () {
        ...
        width = this.width = Math.round(relativeLength(((_a = options.width) !== null && _a !== void 0 ? _a : chart.plotWidth - offsets[3] + offsets[1]), chart.plotWidth)), height = this.height = Math.round(relativeLength(((_b = options.height) !== null && _b !== void 0 ? _b : chart.plotHeight - offsets[0] + offsets[2]), chart.plotHeight)), top = this.top = Math.round(relativeLength(((_c = options.top) !== null && _c !== void 0 ? _c : chart.plotTop + offsets[0]), chart.plotHeight, chart.plotTop)), left = this.left = Math.round(relativeLength(((_d = options.left) !== null && _d !== void 0 ? _d : chart.plotLeft + offsets[3]), chart.plotWidth, chart.plotLeft));
    ...
    Axis.prototype.tickSize = function (prefix) {
        var _a;
        var options = this.options, tickWidth = (_a = options[prefix === 'tick' ? 'tickWidth' : 'minorTickWidth']) !== null && _a !== void 0 ? _a : (prefix === 'tick' && this.isXAxis && !this.categories ? 1 : 0);
            ...
            oldNames.forEach(function (name, oldPos) {
                ...
                if (defined(pos) && oldPos !== pos) {
                    ...
                    if (ticks[oldPos]) {
                        ...
                        _this.isDirty = true; // Mark for redraw
                    }
    ...
    Axis.prototype.getOffset = function () {
        ...
        if ((axisTitleOptions === null || axisTitleOptions === void 0 ? void 0 : axisTitleOptions.text) &&
            ...
            if (showAxis &&
                ...
                titleMargin = defined(titleOffsetOption) ?
                    0 :
                    (_d = axisTitleOptions.margin) !== null && _d !== void 0 ? _d : (horiz ? 5 : 10);
            }
        }
        ...
        if (labelOffset) {
            ...
            labelOffsetPadded += directionFactor * (horiz ?
                ((_e = labelOptions.y) !== null && _e !== void 0 ? _e : (tickRotCorr.y +
                    directionFactor * labelOptions.distance)) :
                ((_f = labelOptions.x) !== null && _f !== void 0 ? _f : (reserveSpaceDefault ?
        ...
        axis.maxLabelDimensions = (_g = axis.getMaxLabelDimensions) === null || _g === void 0 ? void 0 : _g.call(axis, ticks, tickPositions);
    ...
    Axis.prototype.renderLine = function () {
        var _a = this, chart = _a.chart, _b = _a.offset, offset = _b === void 0 ? 0 : _b, options = _a.options;
