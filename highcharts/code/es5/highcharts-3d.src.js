...
(function (Chart3D) {
    ...
    var Additions = /** @class */ (function () {
        ...
        Additions.prototype.get3dFrame = function () {
            ...
            var getFaceOptions = function (sources,
                faceOrientation,
                defaultVisible) {
                    var _a,
                _b;
                ...
                return {
                    size: ((_a = options.size) !== null && _a !== void 0 ? _a : 1),
                    color: ((_b = options.color) !== null && _b !== void 0 ? _b : 'none'),
...
function onAxisAfterSetOptions() {
    ...
    if (((_a = chart.is3d) === null || _a === void 0 ? void 0 : _a.call(chart)) && axis.coll !== 'colorAxis') {
        ...
        options.tickWidth = ((_b = options.tickWidth) !== null && _b !== void 0 ? _b : 0);
        options.gridLineWidth = ((_c = options.gridLineWidth) !== null && _c !== void 0 ? _c : 1);
    }
}
/** @internal */
    ...
    if (axis.categories &&
        ...
        var firstGridLine = (gridGroup.element.childNodes[0].getBBox()),
            ...
            origin_1 = {
                ...
                y: chart.plotHeight / 2,
                z: options3d.depth / 2,
                vd: (((_a = options3d.depth) !== null && _a !== void 0 ? _a : 1) *
                    ((_b = options3d.viewDistance) !== null && _b !== void 0 ? _b : 0))
            },
        ...
        if ((_c = prevTick === null || prevTick === void 0 ? void 0 : prevTick.label) === null || _c === void 0 ? void 0 : _c.xy) {
        ...
        if ((_d = nextTick === null || nextTick === void 0 ? void 0 : nextTick.label) === null || _d === void 0 ? void 0 : _d.xy) {
...
var Axis3DAdditions = /** @class */ (function () {
    ...
    Axis3DAdditions.prototype.fix3dPosition = function (pos, isTitle) {
        ...
        var alpha = Axis3DComposition_deg2rad * chart.options.chart.options3d.alpha,
            ...
            positionMode = ((_a = (isTitle && axis.options.title.position3d)) !== null && _a !== void 0 ? _a : axis.options.labels.position3d),
            skew = ((_b = (isTitle && axis.options.title.skew3d)) !== null && _b !== void 0 ? _b : axis.options.labels.skew3d),
            frame = chart.chart3d.frame3d,
...
var Series3D = /** @class */ (function (_super) {
    ...
    Series3D.prototype.translate3dPoints = function () {
        ...
        var series = this,
            ...
            chart = series.chart,
            zAxis = ((_a = series.zAxis) !== null && _a !== void 0 ? _a : chart.options.zAxis[0]),
            rawPoints = [],
            rawPointsX = [],
            stack = seriesOptions.stacking ?
                ((0,
            highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.isNumber)(seriesOptions.stack) ? seriesOptions.stack : 0) :
                series.index || 0;
        var projectedPoint,
            zValue;
...
(function (SVGRenderer3D) {
    ...
    function face3d(args) {
        ...
        ret.attr = function (hash) {
            ...
            if (typeof hash === 'object' &&
                ...
                this.enabled = ((_a = hash.enabled) !== null && _a !== void 0 ? _a : this.enabled);
                this.vertexes = ((_b = hash.vertexes) !== null && _b !== void 0 ? _b : this.vertexes);
                this.insidePlotArea =
                    (_c = hash.insidePlotArea) !== null && _c !== void 0 ? _c : this.insidePlotArea;
                delete hash.enabled;
        ...
        ret.animate = function (params) {
            ...
            if (typeof params === 'object' &&
                ...
                this.enabled = ((_a = params.enabled) !== null && _a !== void 0 ? _a : this.enabled);
                this.vertexes = ((_b = params.vertexes) !== null && _b !== void 0 ? _b : this.vertexes);
                this.insidePlotArea =
                    (_c = params.insidePlotArea) !== null && _c !== void 0 ? _c : this.insidePlotArea;
    ...
    function arc3d(attribs) {
        ...
        wrapper.animate = function (params, animation, complete) {
            ...
            delete params.z;
            var anim = (0,
                highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.animObject)((animation !== null && animation !== void 0 ? animation : this.renderer.globalAnimation));
            if (anim.duration) {
                var paramArr = extractCustom(params);
                ...
                if (paramArr) {
                    var to_1 = paramArr[0], // Custom attr
                        ...
                        pos) {
                            var _a;
                        return (from[key] + (((_a = to_1[key]) !== null && _a !== void 0 ? _a : from[key]) -
                            from[key]) * pos);
                    };
...
function onChartAfterCreateAxes() {
    var _this = this;
    var zAxisOptions = this.options.zAxis = (0,
        highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.splat)(this.options.zAxis || {});
    if (!this.is3d()) {
        return;
    }
    this.zAxis = [];
...
function columnSeriesTranslate3dShapes() {
    ...
    for (var _i = 0, _a = series.points; _i < _a.length; _i++) {
        ...
        if (point.y !== null) {
            var shapeArgs = (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.extend)({ x: 0, y: 0, width: 0, height: 0 }, point.shapeArgs || {}), 
...
function retrieveStacks(chart, stacking) {
    ...
    series.forEach(function (s) {
        var _a;
        stackNumber = ((_a = s.options.stack) !== null && _a !== void 0 ? _a : (stacking ? 0 : series.length - 1 - s.index)); // #3841, #4532
...
function wrapColumnSeriesPointAttribs(proceed) {
    ...
    if (this.chart.is3d && this.chart.is3d()) {
        ...
        attr['stroke-width'] = ((_a = this.options.edgeWidth) !== null && _a !== void 0 ? _a : 1); // #4055
    }
    return attr;
}
/**
        ...
        for (var _i = 0, _c = series.points; _i < _c.length; _i++) {
            ...
            point.visible = point.options.visible = vis =
                typeof vis === 'undefined' ?
                    !((_a = series.visible) !== null && _a !== void 0 ? _a : point.visible) : vis;
            if (series.options.data) {
                series.options.data[series.data.indexOf(point)] = point.options;
            }
            (_b = point.graphic) === null || _b === void 0 ? void 0 : _b.attr({
...
function wrapSeriesAlignDataLabel(proceed, point, _dataLabel, options, alignTo) {
    ...
    if (chart.is3d() &&
        ...
        var series = this,
            seriesOptions = series.options,
            inside = ((_a = options.inside) !== null && _a !== void 0 ? _a : !!series.options.stacking),
            options3d = chart.options.chart.options3d,
...
var Pie3DSeries = /** @class */ (function (_super) {
    ...
    Pie3DSeries.prototype.animate = function (init) {
        ...
        if (!this.chart.is3d()) {
            ...
            if (init) {
                ...
                group.oldtranslateX =
                    (_a = group.oldtranslateX) !== null && _a !== void 0 ? _a : group.translateX;
                group.oldtranslateY =
                    (_b = group.oldtranslateY) !== null && _b !== void 0 ? _b : group.translateY;
                attribs = {
                    translateX: center[0],
                    translateY: center[1],
                    scaleX: 0.001, // #1499
    ...
    Pie3DSeries.prototype.pointAttribs = function (point) {
        ...
        if (this.chart.is3d() && !this.chart.styledMode) {
            ...
            attr['stroke-width'] = ((_a = options.edgeWidth) !== null && _a !== void 0 ? _a : 1);
        }
        return attr;
    };
    /**
