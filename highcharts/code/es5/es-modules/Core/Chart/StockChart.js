...
function getForcedAxisOptions(type, chartOptions) {
    ...
    if (type === 'xAxis') {
        ...
        // is enabled (#1090)
        var navigatorEnabled = (_c = (_b = (_a = chartOptions.navigator) === null || _a === void 0 ? void 0 : _a.enabled) !== null && _b !== void 0 ? _b : NavigatorDefaults.enabled) !== null && _c !== void 0 ? _c : true;
        var axisOptions = {
            type: 'datetime',
            categories: void 0
        };
...
var StockChart = /** @class */ (function (_super) {
    ...
    StockChart.prototype.init = function (userOptions, callback) {
        ...
        navigatorEnabled = (_c = (_b = (_a = userOptions.navigator) === null || _a === void 0 ? void 0 : _a.enabled) !== null && _b !== void 0 ? _b : NavigatorDefaults.enabled) !== null && _c !== void 0 ? _c : true;
        ...
        var options = merge({
            ...
            scrollbar: {
                ...
                enabled: ((_d = ScrollbarDefaults.enabled) !== null && _d !== void 0 ? _d : true)
            },
            rangeSelector: {
                // #4988 - check if setOptions was called
                enabled: (_e = RangeSelectorDefaults.rangeSelector.enabled) !== null && _e !== void 0 ? _e : true
            },
            title: {
                text: null
            },
