...
var SVGElement = /** @class */ (function () {
    ...
    SVGElement.prototype._defaultGetter = function (key) {
        var _a, _b, _c;
        var ret = ((_c = (_b = (_a = this[key + 'Value']) !== null && _a !== void 0 ? _a : this[key]) !== null && _b !== void 0 ? _b : (this.element ? this.element.getAttribute(key) : null)) !== null && _c !== void 0 ? _c : 0);
    ...
    SVGElement.prototype.animate = function (params, options, complete) {
        var _this = this;
        var _a;
        var animOptions = animObject(((_a = options !== null && options !== void 0 ? options : this.renderer.globalAnimation) !== null && _a !== void 0 ? _a : true)), deferTime = animOptions.defer;
    ...
    */
    ...
    SVGElement.prototype.getBBox = function (reload, rot) {
        var _a;
        var wrapper = this, element = wrapper.element, renderer = wrapper.renderer, styles = wrapper.styles, textStr = wrapper.textStr, cache = renderer.cache, cacheKeys = renderer.cacheKeys, isSVG = element.namespaceURI === wrapper.SVG_NS, rotation = ((_a = rot !== null && rot !== void 0 ? rot : wrapper.rotation) !== null && _a !== void 0 ? _a : 0), fontSize = renderer.styledMode ? (element &&
    ...
    SVGElement.prototype.zIndexSetter = function (value, key) {
        var _a = this, element = _a.element, parentGroup = _a.parentGroup, renderer = _a.renderer, parentNode = (parentGroup === null || parentGroup === void 0 ? void 0 : parentGroup.element) || renderer.box, svgParent = parentNode === renderer.box;
