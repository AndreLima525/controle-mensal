...
function arc(cx, cy, w, h, options) {
    ...
    if (options) {
        ...
        var innerRadius = options.innerR, open_1 = ((_c = options.open) !== null && _c !== void 0 ? _c : fullCircle), cosStart = fullCircle ? 0 : Math.cos(start), sinStart = fullCircle ? 1 : Math.sin(start), cosEnd = fullCircle ? 0 : Math.cos(end), sinEnd = fullCircle ? 1 : Math.sin(end), 
