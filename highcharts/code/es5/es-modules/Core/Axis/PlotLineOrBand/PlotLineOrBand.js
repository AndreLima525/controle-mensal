...
var PlotLineOrBand = /** @class */ (function () {
    ...
    PlotLineOrBand.prototype.render = function () {
        ...
        var _e = this, axis = _e.axis, options = _e.options, chart = axis.chart, horiz = axis.horiz, logarithmic = axis.logarithmic, color = options.color, events = options.events, _f = options.zIndex, zIndex = _f === void 0 ? 0 : _f, _g = axis.chart, renderer = _g.renderer, time = _g.time, groupAttribs = {}, 
        ...
        var optionsLabel = options.label, _h = this, label = _h.label, svgElem = _h.svgElem, path = [], group;
