...
function wrapSeriesAlignDataLabel(proceed, point, _dataLabel, options, alignTo) {
    ...
    if (chart.is3d() &&
        this.is('column')) {
        var series = this, seriesOptions = series.options, inside = ((_a = options.inside) !== null && _a !== void 0 ? _a : !!series.options.stacking), options3d = chart.options.chart.options3d, xOffset = (point.pointWidth || 0) / 2;
        var dLPosition = {
            x: alignTo.x + xOffset,
            y: alignTo.y,
