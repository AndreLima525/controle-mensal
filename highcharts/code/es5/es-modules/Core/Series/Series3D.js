...
var Series3D = /** @class */ (function (_super) {
    ...
    Series3D.prototype.translate3dPoints = function () {
        var _a;
        var series = this, seriesOptions = series.options, chart = series.chart, zAxis = ((_a = series.zAxis) !== null && _a !== void 0 ? _a : chart.options.zAxis[0]), rawPoints = [], rawPointsX = [], stack = seriesOptions.stacking ?
