...
var TreemapSeries = /** @class */ (function (_super) {
    ...
    TreemapSeries.prototype.calculateChildrenAreas = function (parent, area) {
        ...
        var series = this, options = series.options, mapOptionsToLevel = series.mapOptionsToLevel, level = mapOptionsToLevel[parent.level + 1], algorithm = ((_a = ((level === null || level === void 0 ? void 0 : level.layoutAlgorithm) &&
            series[level === null || level === void 0 ? void 0 : level.layoutAlgorithm] &&
            level.layoutAlgorithm)) !== null && _a !== void 0 ? _a : options.layoutAlgorithm), alternate = options.alternateStartingDirection, 
        ...
        var childrenValues = [], axisWidth = ((_d = rootNode.pointValues) === null || _d === void 0 ? void 0 : _d.width) || 0, axisHeight = ((_e = rootNode.pointValues) === null || _e === void 0 ? void 0 : _e.height) || 0;
        ...
        if (options.nodeSizeBy === 'leaf' &&
            ...
            !isNumber((_g = rootNode.point) === null || _g === void 0 ? void 0 : _g.options.value)) {
