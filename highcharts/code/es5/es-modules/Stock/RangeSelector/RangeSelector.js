...
var RangeSelector = /** @class */ (function () {
    ...
    RangeSelector.prototype.createElements = function () {
        var _a, _b;
        var chart = this.chart, renderer = chart.renderer, container = chart.container, chartOptions = chart.options, options = chartOptions.rangeSelector, inputEnabled = options.inputEnabled, inputsZIndex = ((_b = (_a = chartOptions.chart.style) === null || _a === void 0 ? void 0 : _a.zIndex) !== null && _b !== void 0 ? _b : 0) + 1;
    ...
    RangeSelector.prototype.renderButtons = function () {
        ...
        var _h;
        var _j = this, chart = _j.chart, options = _j.options;
    ...
    RangeSelector.prototype.alignElements = function () {
        var _this = this;
        var _a, _b;
        var _c = this, buttonGroup = _c.buttonGroup, buttons = _c.buttons, chart = _c.chart, group = _c.group, inputGroup = _c.inputGroup, options = _c.options, zoomText = _c.zoomText;
        ...
        if (group && buttonPosition && inputPosition) {
            ...
            var _d = this, minInput = _d.minInput, maxInput = _d.maxInput, dropdown = _d.dropdown;
    ...
    RangeSelector.prototype.positionButtons = function () {
        var _a;
        var _b = this, buttons = _b.buttons, chart = _b.chart, options = _b.options, zoomText = _b.zoomText;
