...
function addToolbar(chart, options, callback) {
    ...
    label.appendChild(doc.createTextNode(((_b = (_a = (lang[options.langKey] || options.langKey)) !== null && _a !== void 0 ? _a : (options.shapes && options.shapes[0].type)) !== null && _b !== void 0 ? _b : '')));
    // Add buttons
