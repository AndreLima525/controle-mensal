...
var simpleConnect = function (start, end, options) {
    ...
    var endSegment, dir = ((_a = options.startDirectionX) !== null && _a !== void 0 ? _a : (abs(end.x - start.x) > abs(end.y - start.y))) ? 'x' : 'y', startObstacle, endObstacle, waypoint, useMax, endPoint;
...
function fastAvoid(start, end, options) {
    ...
    */
    var dirIsX = (_a = options.startDirectionX) !== null && _a !== void 0 ? _a : (abs(end.x - start.x) > abs(end.y - start.y)), dir = dirIsX ? 'x' : 'y', endSegments = [], 
