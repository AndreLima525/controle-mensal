 ...
 * @return {void}
 */
export function animate(el, params, opt) {
    ...
    objectEach(params, function (val, prop) {
        ...
        var fx = new Fx(el, opt, prop), d = params.d;
        var start = 0, end = void 0, unit = '';
        if (prop === 'd' && isArray(d)) {
 ...
 */
export var stop = function (el, prop) {
    return Fx.timers.forEach(function (timer) {
