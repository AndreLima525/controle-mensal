...
var Tooltip = /** @class */ (function () {
    ...
    Tooltip.prototype.refresh = function (pointOrPoints, mouseEvent) {
        var _this = this;
        var _a;
        var tooltip = this, _b = this, chart = _b.chart, options = _b.options, pointer = _b.pointer, shared = _b.shared, points = splat(pointOrPoints), point = points[0], formatString = options.format, formatter = options.formatter || tooltip.defaultFormatter, styledMode = chart.styledMode;
    ...
    Tooltip.prototype.renderSplit = function (labels, points) {
        ...
        var boxes = labels.slice(0, points.length + 1).reduce(function (boxes, str, i) {
            ...
            if (str !== false && str !== '') {
                ...
                var _b = getAnchor(point), anchorX = _b.anchorX, anchorY = _b.anchorY;
