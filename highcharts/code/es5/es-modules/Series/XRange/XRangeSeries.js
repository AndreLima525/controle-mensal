...
var XRangeSeries = /** @class */ (function (_super) {
    ...
    XRangeSeries.prototype.translatePoint = function (point) {
        ...
        var xAxis = this.xAxis, yAxis = this.yAxis, metrics = this.columnMetrics, options = this.options, minPointLength = options.minPointLength || 0, oldColWidth = (((_a = point.shapeArgs) === null || _a === void 0 ? void 0 : _a.width) || 0) / 2, seriesXOffset = this.pointXOffset = metrics.offset, posX = (_b = point.x2) !== null && _b !== void 0 ? _b : (point.x + (point.len || 0)), borderRadius = options.borderRadius, plotTop = this.chart.plotTop, plotLeft = this.chart.plotLeft;
        var plotX = point.plotX, plotX2 = xAxis.translate(posX, 0, 0, 0, 1);
        var length = Math.abs(plotX2 - plotX), inverted = this.chart.inverted, borderWidth = (_c = options.borderWidth) !== null && _c !== void 0 ? _c : 1;
