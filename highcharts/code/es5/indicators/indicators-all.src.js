    ...
    AroonIndicator.prototype.getValues = function (series, params) {
        ...
        for (i = period - 1; i < yValLen; i++) {
            ...
            xLow = getExtremeIndexInArray(slicedY.map(function (elem) {
                var _a;
                return ((_a = elem[low]) !== null && _a !== void 0 ? _a : elem);
            }), 'min');
            xHigh = getExtremeIndexInArray(slicedY.map(function (elem) {
                var _a;
                return ((_a = elem[high]) !== null && _a !== void 0 ? _a : elem);
            }), 'max');
...
var BBIndicator = /** @class */ (function (_super) {
    ...
    BBIndicator.prototype.getValues = function (series, params) {
        ...
        var isOHLC = (0,
            highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.isArray)(yVal[0]);
        for (i = period; i <= yValLen; i++) {
...
function accumulatePoints(sum, yVal, i, index, subtract) {
    var _a;
    var price = ((_a = yVal[i][index]) !== null && _a !== void 0 ? _a : yVal[i]);
    if (subtract) {
...
var DPOIndicator = /** @class */ (function (_super) {
    ...
    DPOIndicator.prototype.getValues = function (series, params) {
        ...
        for (j = 0; j <= yValLen - range; j++) {
            ...
            price = (_a = yVal[rangeIndex][index]) !== null && _a !== void 0 ? _a : yVal[rangeIndex];
...
var TEMAIndicator = /** @class */ (function (_super) {
    ...
    TEMAIndicator.prototype.getTemaPoint = function (xVal, tripledPeriod, EMAlevels, i) {
        var TEMAPoint = [
                xVal[i - 3],
                (0,
            highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.correctFloat)(3 * EMAlevels.level1 -
...
var IKHIndicator = /** @class */ (function (_super) {
    ...
    IKHIndicator.prototype.drawGraph = function () {
        ...
        (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.objectEach)(ikhMap, function (values, lineName) {
            if (mainLineOptions[lineName] &&
                lineName !== 'senkouSpan') {
    ...
    IKHIndicator.prototype.getValues = function (series, params) {
        var period = params.period,
            ...
            yValLen = (yVal && yVal.length) || 0,
            closestPointRange = (0,
            highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.getClosestDistance)(xAxis.series.map(function (s) { return s.getColumn('x'); })),
            IKH = [],
            xData = [];
        var date,
            slicedTSY,
...
var KlingerIndicator = /** @class */ (function (_super) {
    ...
    KlingerIndicator.prototype.isValidData = function (firstYVal) {
        var chart = this.chart,
            ...
            series = this.linkedParent,
            isSeriesOHLC = (0,
            highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.isArray)(firstYVal) &&
                firstYVal.length === 4,
            volumeSeries = this.volumeSeries ||
                (this.volumeSeries =
                    chart.get(options.params.volumeSeriesID));
...
var MACDIndicator = /** @class */ (function (_super) {
    ...
    MACDIndicator.prototype.drawGraph = function () {
        ...
        ['macd', 'signal'].forEach(function (lineName, i) {
            ...
            indicator.options = (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.merge)(((_a = mainLineOptions["" + lineName + "Line"]) === null || _a === void 0 ? void 0 : _a.styles) || {}, gappedExtend);
...
var OBVIndicator = /** @class */ (function (_super) {
    ...
    OBVIndicator.prototype.getValues = function (series, params) {
        var volumeSeries = series.chart.get(params.volumeSeriesID),
            ...
            yData = [],
            hasOHLC = !(0,
            highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.isNumber)(yVal[0]);
        var OBVPoint = [],
            i = 1,
            previousOBV = 0,
            currentOBV = 0,
...
var SupertrendIndicator = /** @class */ (function (_super) {
    ...
    SupertrendIndicator.prototype.init = function () {
        ...
        var unbinder = (0,
            highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.addEvent)(this.chart.constructor, 'afterLinkSeries',
            function () {
                var _a,
            _b,
            _c;
...
var VBPIndicator = /** @class */ (function (_super) {
    ...
    VBPIndicator.prototype.getValues = function (series, params) {
        ...
        var isOHLC = (0,
            highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.isArray)(yValues[0]);
    ...
    VBPIndicator.prototype.specifyZones = function (isOHLC, xValues, yValues, ranges, volumeSeries) {
        ...
        var lowRange = rangeExtremes ?
                rangeExtremes.min :
                (0,
            highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.arrayMin)(yValues),
            highRange = rangeExtremes ?
                rangeExtremes.max :
                (0,
            highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.arrayMax)(yValues),
            i = 0,
            j = 1;
        ...
        var rangeStep = indicator.rangeStep =
                (0,
            highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.correctFloat)(highRange - lowRange) / ranges;
...
var LinearRegressionIndicator = /** @class */ (function (_super) {
    ...
    LinearRegressionIndicator.prototype.getRegressionLineParameters = function (xData, yData) {
        ...
        var yIndex = this.options.params.index,
            ...
            yIndex) {
                return (0,
            highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.isArray)(yValue) ? yValue[yIndex] : yValue;
...
var TrendLineIndicator = /** @class */ (function (_super) {
    ...
    TrendLineIndicator.prototype.getValues = function (series, params) {
        ...
        for (var i = 0; i < xVal.length; i++) {
            var y = (0,
                highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.isArray)(yVal[i]) ? yVal[i][index] : yVal[i];
