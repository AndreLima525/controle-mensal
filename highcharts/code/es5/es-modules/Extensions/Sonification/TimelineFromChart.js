...
function getParamValWithDefault(context, propMetrics, useSeriesExtremes, mappingParamOptions, fallback, defaults, contextValueProp) {
    var _a;
    return ((_a = getMappingParameterValue(context, propMetrics, useSeriesExtremes, extend({
...
function isActive(context, activeWhen, lastPropValue) {
    ...
    if (typeof activeWhen === 'object') {
        var prop = activeWhen.prop, val = (_a = context.value) !== null && _a !== void 0 ? _a : (context.point && getPointPropValue(context.point, prop));
        if (typeof val !== 'number') {
            return false;
        }
        var crossingOk = true;
        ...
        var max = ((_b = activeWhen.max) !== null && _b !== void 0 ? _b : Infinity), min = ((_c = activeWhen.min) !== null && _c !== void 0 ? _c : -Infinity);
