...
(function (A11yI18nComposition) {
    ...
    function formatExtendedStatement(statement, ctx) {
        ...
        if (pluralStart > -1) {
            ...
            switch (num) {
                case 0:
                    result = ((_a = pluralArguments[4]) !== null && _a !== void 0 ? _a : pluralArguments[1]);
                    break;
                case 1:
                    result = ((_b = pluralArguments[2]) !== null && _b !== void 0 ? _b : pluralArguments[1]);
                    break;
                case 2:
                    result = ((_c = pluralArguments[3]) !== null && _c !== void 0 ? _c : pluralArguments[1]);
                    break;
                default:
...
(function (FocusBorderComposition) {
    ...
    function svgElementAddFocusBorder(margin, attribs) {
        ...
        // Add the border rect
        var bb = this.getBBox(),
            pad = (margin !== null && margin !== void 0 ? margin : 3),
...
var InfoRegionsComponent = /** @class */ (function (_super) {
    ...
    InfoRegionsComponent.prototype.getAxesDescription = function () {
        var chart = this.chart,
            ...
            var axisA11yEnabled = axes[0] ?
                    (axes[0].options.accessibility &&
                        axes[0].options.accessibility.enabled) :
                    void 0;
            return axes.length > 1 || (axisA11yEnabled !== null && axisA11yEnabled !== void 0 ? axisA11yEnabled : defaultCondition);
        ...
        this.addEvent((highcharts_Legend_commonjs_highcharts_Legend_commonjs2_highcharts_Legend_root_Highcharts_Legend_default()), 'afterRender', function () {
            ...
            if (this.chart === component.chart &&
                ...
                (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.syncTimeout)(function () { return component.proxyProvider
                    .updateGroupProxyElementPositions('legend'); }, (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.animObject)(((_a = this.chart.renderer.globalAnimation) !== null && _a !== void 0 ? _a : true)).duration);
            }
        });
    };
    /**
    ...
    NavigatorComponent.prototype.init = function () {
        ...
        this.addEvent(Navigator_Navigator, 'afterRender', function () {
            ...
            if (this.chart === component.chart &&
                ...
                }, (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.animObject)(((_a = this.chart.renderer.globalAnimation) !== null && _a !== void 0 ? _a : true)).duration);
            }
        });
    };
    /**
...
function addMockPointElement(point) {
    ...
    var series = point.series,
        ...
        mockPos = firstPointWithGraphic ? {
            x: ((_b = (_a = point.plotX) !== null && _a !== void 0 ? _a : firstPointWithGraphic.plotX) !== null && _b !== void 0 ? _b : 0),
            y: ((_d = (_c = point.plotY) !== null && _c !== void 0 ? _c : firstPointWithGraphic.plotY) !== null && _d !== void 0 ? _d : 0)
        } : {
            x: ((_e = point.plotX) !== null && _e !== void 0 ? _e : 0),
            y: ((_f = point.plotY) !== null && _f !== void 0 ? _f : 0)
        },
...
function getPointArrayMapValueDescription(point, prefix, suffix) {
    var pre = prefix || '', suf = suffix || '', keyToValStr = function (key) {
            var _a;
        var num = pointNumberToString(point, ((_a = point[key]) !== null && _a !== void 0 ? _a : point.options[key]));
        return num !== void 0 ?
            key + ': ' + pre + num + suf :
            num;
...
function getPointValueDescription(point) {
    ...
    var series = point.series, chart = series.chart, seriesA11yOptions = series.options.accessibility, seriesValueDescFormat = seriesA11yOptions && seriesA11yOptions.point &&
            ...
            chart.options.accessibility.point.valueDescriptionFormat, showXDescription = ((_a = (series.xAxis &&
            series.xAxis.options.accessibility &&
            series.xAxis.options.accessibility.enabled)) !== null && _a !== void 0 ? _a : (!chart.angular && series.type !== 'flowmap')), xDesc = showXDescription ? getPointXDescription(point) : '', context = {
            point: point,
...
function defaultSeriesDescriptionFormatter(series) {
    ...
    var chart = series.chart,
        ...
        series: series,
        chart: chart
    }, combinationSuffix = chartTypes.length > 1 ? 'Combination' : '', summary = chart.langFormat('accessibility.series.summary.' + series.type + combinationSuffix, summaryContext) || chart.langFormat('accessibility.series.summary.default' + combinationSuffix, summaryContext), axisDescription = (shouldDescribeAxis('yAxis') ? ' ' + yAxisInfo + '.' : '') + (shouldDescribeAxis('xAxis') ? ' ' + xAxisInfo + '.' : ''), formatStr = ((_b = (_a = (series.options.accessibility &&
        series.options.accessibility.descriptionFormat)) !== null && _a !== void 0 ? _a : chart.options.accessibility.series.descriptionFormat) !== null && _b !== void 0 ? _b : '');
...
function isSkipPoint(point) {
    ...
    var series = point.series,
        ...
        // (#24650).
        skipNullPoints = (_a = a11yOptions
            .keyboardNavigation
            .seriesNavigation
            .skipNullPoints) !== null && _a !== void 0 ? _a : !nullInteraction;
                ...
                [
                    ...
                    function () {
                        var res = onClick(this,
                            chart);
                        return (res !== null && res !== void 0 ? res : this.response.success);
                    }
                ]
            ],
            validate: function () {
...
function traverseSetOption(root, optionAsArray, val) {
    ...
    for (; i < optionAsArray.length - 1; ++i) {
        ...
        opt = opt[prop] = ((_a = opt[prop]) !== null && _a !== void 0 ? _a : {});
    }
...
var Accessibility_escapeStringForHTML = Utils_HTMLUtilities.escapeStringForHTML, Accessibility_removeElement = Utils_HTMLUtilities.removeElement, Accessibility_stripHTMLTagsFromString = Utils_HTMLUtilities.stripHTMLTagsFromString;
...
(function (Accessibility) {
    ...
    function chartOnGetSVG(e) {
        ...
        var infoRegions = a11y.components.infoRegions;
        var text = infoRegions && (infoRegions.getLongdescText() ||
                infoRegions.getTypeDescriptionText());
        if (!text) {
            return;
        }
        var safe = Accessibility_escapeStringForHTML(Accessibility_stripHTMLTagsFromString(text,
            true));
        if (!safe.trim()) {
            return;
        }
        var box = e.chartCopy.renderer.box;
        (_a = box.querySelector(':scope > metadata')) === null || _a === void 0 ? void 0 : _a.remove();
