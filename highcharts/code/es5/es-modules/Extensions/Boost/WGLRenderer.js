    ...
    WGLRenderer.prototype.renderChart = function (chart) {
        ...
        this.series.forEach(function (s, si) {
            ...
            var options = s.series.options, shapeOptions = options.marker, lineWidth = (typeof options.lineWidth !== 'undefined' ?
                options.lineWidth :
                1), threshold = options.threshold, hasThreshold = isNumber(threshold), yBottom = s.series.yAxis.getThreshold(threshold), translatedThreshold = yBottom, showMarkers = ((_b = (_a = (options.marker ? options.marker.enabled : null)) !== null && _a !== void 0 ? _a : (s.series.xAxis.isRadial ? true : null)) !== null && _b !== void 0 ? _b : s.series.closestPointRangePx > 2 * ((options.marker ?
            ...
            if (s.series.fillOpacity &&
                options.fillOpacity &&
                fillColor) {
                fillColor = new Color(fillColor).setOpacity(((_f = options.fillOpacity) !== null && _f !== void 0 ? _f : 1.0)).get();
            }
            ...
            if (lineWidth > 0 || s.drawMode !== 'LINE_STRIP') {
                var _k = getBoostClipRect(chart, s.series), cx = _k.x, cy = _k.y, cw = _k.width, ch = _k.height;
