...
var Series = /** @class */ (function () {
    ...
    Series.prototype.autoIncrement = function (x) {
        var _a, _b, _c, _d;
        var options = this.options, _e = this.options, pointIntervalUnit = _e.pointIntervalUnit, relativeXValue = _e.relativeXValue, time = this.chart.time, xIncrement = (_b = (_a = this.xIncrement) !== null && _a !== void 0 ? _a : time.parse(options.pointStart)) !== null && _b !== void 0 ? _b : 0;
        var pointInterval;
    ...
    Series.prototype.setOptions = function (itemOptions) {
        ...
        // plotOptions.series
        userPlotOptionsType, seriesUserOptions), negativeColor = options.negativeColor, negativeFillColor = options.negativeFillColor, _f = options.zoneAxis, zoneAxis = _f === void 0 ? 'y' : _f, zones = options.zones, 
        // #20440, create deep copy of zones options
        zonesCopy = (zones || []).map(function (z) { return (__assign({}, z)); });
    ...
    oldIndexColumn) {
        ...
        for (i = 0; i < dataTable.rowCount; i++) {
            var x = newXColumn === null || newXColumn === void 0 ? void 0 : newXColumn[i], id = newIdColumn === null || newIdColumn === void 0 ? void 0 : newIdColumn[i], name_1 = newNameColumn === null || newNameColumn === void 0 ? void 0 : newNameColumn[i], index = newIndexColumn === null || newIndexColumn === void 0 ? void 0 : newIndexColumn[i], _c = id && oldIdColumn ?
                [id, oldIdColumn] :
    ...
    Series.prototype.setData = function (data, redraw, animation, updatePoints) {
        ...
        var series = this, table = this.dataTable, options = series.options, oldData = series.points, oldDataLength = (oldData === null || oldData === void 0 ? void 0 : oldData.length) || 0, oldXColumn = table.getColumn('x'), oldIdColumn = table.getColumn('id'), oldNameColumn = (
        ...
        ((_a = options.dataSorting) === null || _a === void 0 ? void 0 : _a.matchByName) &&
            (oldData === null || oldData === void 0 ? void 0 : oldData.map(function (point) { return point.name; }))) || table.getColumn('name'), oldIndexColumn = table.getColumn('index'), chart = series.chart, xAxis = series.xAxis;
        ...
        if (!updatedData) {
            ...
            i = oldDataLength;
            while (i--) {
                (_b = oldData[i]) === null || _b === void 0 ? void 0 : _b.destroy();
            }
            // Reset minRange (#878)
            if (xAxis) {
    ...
    Series.prototype.translate = function () {
        var _a, _b;
        this.generatePoints();
        var series = this, hasRendered = series.hasRendered, options = series.options, xAxis = series.xAxis, yAxis = series.yAxis, stacking = options.stacking, threshold = options.threshold, polar = series.chart.polar, points = series.points.concat(series.condemnedPoints), dataLength = points.length, pointPlacement = series.pointPlacementToXValue(), // #7860
    ...
    Series.prototype.markerAttribs = function (point, state) {
        var _a, _b, _c, _d, _e, _f;
        var seriesOptions = this.options, seriesMarkerOptions = (_a = seriesOptions.marker) !== null && _a !== void 0 ? _a : {}, pointMarkerOptions = point.marker || {}, symbol = (pointMarkerOptions.symbol ||
            seriesMarkerOptions.symbol), attribs = {};
        var seriesStateOptions, pointStateOptions, radius = (_b = pointMarkerOptions.radius) !== null && _b !== void 0 ? _b : seriesMarkerOptions.radius;
    ...
    Series.prototype.pointAttribs = function (point, state) {
        ...
        var options = this.options, seriesMarkerOptions = (_a = options.marker) !== null && _a !== void 0 ? _a : {}, pointOptions = point === null || point === void 0 ? void 0 : point.options, pointMarkerOptions = (pointOptions === null || pointOptions === void 0 ? void 0 : pointOptions.marker) || {}, pointColorOption = pointOptions === null || pointOptions === void 0 ? void 0 : pointOptions.color, pointColor = point === null || point === void 0 ? void 0 : point.color, zoneColor = (_b = point === null || point === void 0 ? void 0 : point.zone) === null || _b === void 0 ? void 0 : _b.color;
        var color = this.color, fill, stroke, strokeWidth = (_c = pointMarkerOptions.lineWidth) !== null && _c !== void 0 ? _c : seriesMarkerOptions.lineWidth, opacity = ((point === null || point === void 0 ? void 0 : point.isNull) && options.nullInteraction) ? 0 : 1;
    ...
    Series.prototype.destroy = function (keepEventsForUpdate) {
        ...
        i = data.length;
        while (i--) {
            (_b = (_a = data[i]) === null || _a === void 0 ? void 0 : _a.destroy) === null || _b === void 0 ? void 0 : _b.call(_a, true);
        }
    ...
    Series.prototype.applyZones = function () {
        ...
        avoidClose = function (zone, plotX, plotY) {
            ...
            var _a = zone.translated, translated = _a === void 0 ? 0 : _a, lineClip = zone.lineClip, value = zone.value, distance = plotY - translated;
    ...
    Series.prototype.buildKDTree = function (e) {
        ...
        var series = this, seriesOptions = series.options, dimensions = ((_a = seriesOptions.findNearestPointBy) !== null && _a !== void 0 ? _a : '')
            .indexOf('y') > -1 ? 2 : 1;
        /**
         * Internal function
         * @internal
    ...
    Series.prototype.hasOptionChanged = function (optionName) {
        var _a, _b, _c;
        var chart = this.chart, option = this.options[optionName], plotOptions = chart.options.plotOptions, oldOption = this.userOptions[optionName], plotOptionsOption = ((_b = (_a = plotOptions === null || plotOptions === void 0 ? void 0 : plotOptions[this.type]) === null || _a === void 0 ? void 0 : _a[optionName]) !== null && _b !== void 0 ? _b : (_c = plotOptions === null || plotOptions === void 0 ? void 0 : plotOptions.series) === null || _c === void 0 ? void 0 : _c[optionName]);
