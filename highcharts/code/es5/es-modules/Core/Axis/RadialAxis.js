...
(function (RadialAxis) {
    ...
    function getLinePath(_lineWidth, radius, innerRadius) {
        ...
        var end, path, r = (radius !== null && radius !== void 0 ? radius : center[2] / 2 - this.offset);
    ...
    function getPlotBandPath(from, to, options) {
        ...
        var start, end, angle, xOnPerimeter, open, path, outerRadius = ((_b = radiusToPixels(options.outerRadius)) !== null && _b !== void 0 ? _b : fullRadius), innerRadius = radiusToPixels(options.innerRadius), thickness = radiusToPixels(options.thickness), brStart = true, brEnd = true;
        ...
        if (this.options.gridLineInterpolation === 'polygon') {
            ...
            path = chart.renderer.symbols.arc(left + center[0], top + center[1], outerRadius, outerRadius, {
                ...
                innerR: innerRadius !== null && innerRadius !== void 0 ? innerRadius : (isNumber(thickness) ?
    ...
    function getPlotLinePath(options) {
        ...
        if (this.isCircular) {
            ...
            // point.
            var transValue = clamp(this.translate(value), 0, height);
