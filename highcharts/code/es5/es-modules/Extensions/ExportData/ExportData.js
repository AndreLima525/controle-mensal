...
(function (ExportData) {
    ...
    function getTableAST(useLocalDecimalPoint) {
        var _a, _b;
        var rowLength = 0;
        var treeChildren = [], exporting = this, chart = exporting.chart, options = chart.options, decimalPoint = useLocalDecimalPoint ? (1.1).toLocaleString()[1] : void 0, useMultiLevelHeaders = (_a = exporting.options.useMultiLevelHeaders) !== null && _a !== void 0 ? _a : true, rows = exporting.getDataRows(useMultiLevelHeaders), topHeaders = useMultiLevelHeaders ? rows.shift() : null, subHeaders = rows.shift(), 
