...
var TreegraphSeries = /** @class */ (function (_super) {
    ...
    TreegraphSeries.prototype.translateLink = function (link) {
        ...
        var fromNode = link.fromNode, toNode = link.toNode, linkWidth = ((_a = this.options.link) === null || _a === void 0 ? void 0 : _a.lineWidth) || 0, factor = (_c = (_b = this.options.link) === null || _b === void 0 ? void 0 : _b.curveFactor) !== null && _c !== void 0 ? _c : 0.5, hasXData = toNode.x !== toNode.node.level ||
            fromNode.x !== fromNode.node.level, type = ((_g = (_e = (_d = link.options.link) === null || _d === void 0 ? void 0 : _d.type) !== null && _e !== void 0 ? _e : (_f = this.options.link) === null || _f === void 0 ? void 0 : _f.type) !== null && _g !== void 0 ? _g : 'default');
    ...
    TreegraphSeries.prototype.pointAttribs = function (point, state) {
        ...
        var series = this, levelOptions = point &&
            ...
            {}, options = (point === null || point === void 0 ? void 0 : point.options) || {}, stateOptions = ((_a = levelOptions.states) === null || _a === void 0 ? void 0 : _a[state || 'normal']) || {};
        if (point) {
            point.options.marker = merge(series.options.marker, levelOptions.marker, point.options.marker);
        }
        var linkColor = ((_g = (_e = (_c = (_b = stateOptions.link) === null || _b === void 0 ? void 0 : _b.color) !== null && _c !== void 0 ? _c : (_d = options.link) === null || _d === void 0 ? void 0 : _d.color) !== null && _e !== void 0 ? _e : (_f = levelOptions.link) === null || _f === void 0 ? void 0 : _f.color) !== null && _g !== void 0 ? _g : (_h = series.options.link) === null || _h === void 0 ? void 0 : _h.color), linkLineWidth = ((_p = (_m = (_k = (_j = stateOptions.link) === null || _j === void 0 ? void 0 : _j.lineWidth) !== null && _k !== void 0 ? _k : (_l = options.link) === null || _l === void 0 ? void 0 : _l.lineWidth) !== null && _m !== void 0 ? _m : (_o = levelOptions.link) === null || _o === void 0 ? void 0 : _o.lineWidth) !== null && _p !== void 0 ? _p : (_q = series.options.link) === null || _q === void 0 ? void 0 : _q.lineWidth), attribs = seriesProto.pointAttribs.call(series, point, state);
        if (point) {
            if (point.isLink) {
    ...
    TreegraphSeries.prototype.translateNode = function (point) {
        var _a, _b;
        var chart = this.chart, node = point.node, _c = point.plotX, plotX = _c === void 0 ? 0 : _c, plotSizeY = chart.plotSizeY, plotSizeX = chart.plotSizeX, 
        // Get the layout modifiers which are common for all nodes.
        _d = this.layoutModifier, ax = _d.ax, bx = _d.bx, ay = _d.ay, by = _d.by, x = this.isCartesian ?
            ...
            y - height / 2), borderRadius = ((_b = (_a = point.options.borderRadius) !== null && _a !== void 0 ? _a : level.borderRadius) !== null && _b !== void 0 ? _b : this.options.borderRadius), symbolFn = symbols[symbol || 'circle'];
        if (symbolFn === void 0) {
            point.hasImage = true;
        ...
        if (!point.visible && point.linkToParent) {
            ...
            if (parentNode) {
                var parentShapeArgs = parentNode.shapeArgs || {}, _e = parentShapeArgs.x, x_1 = _e === void 0 ? 0 : _e, _f = parentShapeArgs.y, y_1 = _f === void 0 ? 0 : _f, _g = parentShapeArgs.width, width_1 = _g === void 0 ? 0 : _g, _h = parentShapeArgs.height, height_1 = _h === void 0 ? 0 : _h;
                if (!point.shapeArgs) {
                    point.shapeArgs = {};
                }
                if (!point.hasImage) {
