...
var Funnel3DSeries = /** @class */ (function (_super) {
    ...
    Funnel3DSeries.prototype.alignDataLabel = function (point, _dataLabel, options) {
        var _a, _b, _c, _d;
        var series = this, dlBoxRaw = point.dlBoxRaw, inverted = series.chart.inverted, below = point.plotY >
            ((_a = series.translatedThreshold) !== null && _a !== void 0 ? _a : series.yAxis.len), inside = ((_b = options.inside) !== null && _b !== void 0 ? _b : !!series.options.stacking), dlBox = {
            x: dlBoxRaw.x,
            y: dlBoxRaw.y,
            height: 0
        };
