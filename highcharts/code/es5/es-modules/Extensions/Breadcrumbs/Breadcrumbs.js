...
var Breadcrumbs = /** @class */ (function () {
    ...
    Breadcrumbs.prototype.getButtonText = function (breadcrumb) {
        var _a, _b;
        var breadcrumbs = this, chart = breadcrumbs.chart, breadcrumbsOptions = breadcrumbs.options, lang = chart.options.lang, textFormat = (_a = breadcrumbsOptions.format) !== null && _a !== void 0 ? _a : (breadcrumbsOptions.showFullPath ?
            '{level.name}' :
            '← {level.name}'), defaultText = lang && ((_b = lang.drillUpText) !== null && _b !== void 0 ? _b : lang.mainBreadcrumb);
