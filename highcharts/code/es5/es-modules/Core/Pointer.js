...
var Pointer = /** @class */ (function () {
    ...
    Pointer.prototype.onContainerMouseLeave = function (e) {
        var _a;
        var pointer = (charts[((_a = Pointer.hoverChartIndex) !== null && _a !== void 0 ? _a : -1)] || {}).pointer;
        e = this.normalize(e);
        this.onContainerMouseMove(e);
    ...
    Pointer.prototype.onDocumentMouseUp = function (e) {
        ...
        (_d = (_c = charts[((_b = Pointer.hoverChartIndex) !== null && _b !== void 0 ? _b : -1)]) === null || _c === void 0 ? void 0 : _c.pointer) === null || _d === void 0 ? void 0 : _d.drop(e);
    };
    /**
    ...
    Pointer.prototype.pinch = function (e) {
        ...
        function (touch) { return pointer.normalize(touch); }), touchesLength = touches.length, fireClickEvent = touchesLength === 1 && ((pointer.inClass(e.target, 'highcharts-tracker') &&
            ...
            ((_b = (_a = chart.tooltip) === null || _a === void 0 ? void 0 : _a.options.followTouchMove) !== null && _b !== void 0 ? _b : true);
    ...
    */
    Pointer.prototype.setPointerCapture = function () {
        ...
        var pointer = this, events = pointer.pointerCaptureEventsToUnbind, chart = pointer.chart, container = chart.container, followTouchMove = (_b = (_a = chart.options.tooltip) === null || _a === void 0 ? void 0 : _a.followTouchMove) !== null && _b !== void 0 ? _b : true, shouldHave = followTouchMove && chart.series.some(function (series) { return series.options.findNearestPointBy
            .indexOf('y') > -1; });
    ...
    Pointer.prototype.setHoverChartIndex = function (e) {
        var _a, _b;
        var chart = this.chart;
        var hoverChart = H.charts[((_a = Pointer.hoverChartIndex) !== null && _a !== void 0 ? _a : -1)];
        if (hoverChart &&
            hoverChart !== chart) {
    ...
    Pointer.prototype.touch = function (e, start) {
        var _a, _b, _c;
        var _d = this, chart = _d.chart, _e = _d.pinchDown, pinchDown = _e === void 0 ? [] : _e;
