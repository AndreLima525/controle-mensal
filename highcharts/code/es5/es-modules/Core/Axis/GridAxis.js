...
function onAfterGetTitlePosition(e) {
    ...
    if (gridOptions.enabled === true) {
        ...
        var axisTitle = axis.axisTitle, axisHeight = axis.height, horiz = axis.horiz, axisLeft = axis.left, offset = axis.offset, opposite = axis.opposite, options_1 = axis.options, axisTop = axis.top, axisWidth = axis.width, tickSize = axis.tickSize(), titleWidth = axisTitle === null || axisTitle === void 0 ? void 0 : axisTitle.getBBox().width, title = options_1.title, x = title.x, y = title.y, margin = (_a = title.margin) !== null && _a !== void 0 ? _a : (horiz ? 5 : 10), titleFontSize = axisTitle ? axis.chart.renderer.fontMetrics(axisTitle).f : 0, crispCorr = tickSize ? tickSize[0] / 2 : 0, offAxis = ((horiz ? axisTop + axisHeight : axisLeft) +
        ...
        if (!horiz) {
            var _b = (tickSize || [])[0], slotWidth = _b === void 0 ? 0 : _b;
...
function onTickLabelFormat(ctx) {
    ...
    if ((_a = axis.options.grid) === null || _a === void 0 ? void 0 : _a.enabled) {
        ...
        var point = allSeries_1[0] && find(allSeriesData, function (p) {
