...
(function (RangeDataLabel) {
    ...
    function applyAlignToKeyValue(options) {
        var alignToKey = options.alignToKey, format = options.format;
    ...
    function alignDataLabel(point, dataLabel, options, alignTo, isNew) {
        var _a, _b, _c, _d;
        var series = this, alignToKey = resolveAlignToKey(series, options.alignToKey), plotY = getPointPlotY(point, alignToKey), shapeArgs = point.shapeArgs, originalPlotY = point.plotY, originalDlBox = point.dlBox, originalBelow = point.below;
        if (isNumber(plotY)) {
            point.plotY = plotY;
            ...
            var below = point.below = getBelow(point, options, plotY);
