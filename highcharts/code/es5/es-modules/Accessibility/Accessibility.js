...
var escapeStringForHTML = HU.escapeStringForHTML, removeElement = HU.removeElement, stripHTMLTagsFromString = HU.stripHTMLTagsFromString;
...
(function (Accessibility) {
    ...
    function chartOnGetSVG(e) {
        ...
        var safe = escapeStringForHTML(stripHTMLTagsFromString(text, true));
        if (!safe.trim()) {
            return;
        }
