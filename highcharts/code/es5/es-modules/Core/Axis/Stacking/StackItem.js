...
var StackItem = /** @class */ (function () {
    ...
    StackItem.prototype.setOffset = function (xOffset, width, boxBottom, boxTop, defaultX, xAxis) {
        var _a, _b;
        var _c = this, alignOptions = _c.alignOptions, axis = _c.axis, label = _c.label, options = _c.options, textAlign = _c.textAlign, chart = axis.chart, stackBox = this.getStackBox({
            xOffset: xOffset,
            width: width,
            boxBottom: boxBottom,
            boxTop: boxTop,
        ...
        if (label && stackBox) {
            ...
            var isJustify = ((_a = options.overflow) !== null && _a !== void 0 ? _a : 'justify') === 'justify', visible = void 0;
            ...
            var _d = this.adjustStackPosition({
                labelBox: labelBox,
    ...
    StackItem.prototype.getStackBox = function (stackBoxProps) {
        ...
        var stackItem = this, axis = this.axis, chart = axis.chart, boxTop = stackBoxProps.boxTop, defaultX = stackBoxProps.defaultX, xOffset = stackBoxProps.xOffset, width = stackBoxProps.width, boxBottom = stackBoxProps.boxBottom, totalStackValue = axis.stacking.usePercentage ?
            100 :
            ((_a = boxTop !== null && boxTop !== void 0 ? boxTop : this.total) !== null && _a !== void 0 ? _a : 0), y = axis.toPixels(totalStackValue), xAxis = stackBoxProps.xAxis || chart.xAxis[0], x = (defaultX !== null && defaultX !== void 0 ? defaultX : xAxis.translate(this.x)) + xOffset, yZero = axis.toPixels(boxBottom ||
            (isNumber(axis.min) &&
                axis.logarithmic &&
