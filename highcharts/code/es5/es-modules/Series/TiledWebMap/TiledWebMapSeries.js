...
var TiledWebMapSeries = /** @class */ (function (_super) {
    ...
    TiledWebMapSeries.prototype.drawPoints = function () {
        ...
        var tiles = (this.tiles = this.tiles || {}), transformGroups = (this.transformGroups = this.transformGroups || []), series = this, options = this.options, provider = options.provider, zoom = mapView.zoom, lambda = ((_a = (mapView.projection.options.rotation &&
            mapView.projection.options.rotation[0])) !== null && _a !== void 0 ? _a : 0), worldSize = 400.979322, tileSize = 256, duration = chart.renderer.forExport ? 0 : 200, animateTiles = function (duration) {
