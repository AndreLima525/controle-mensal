...
var helpers = {
    ...
    multiply: function (a, b) { return correctFloat(a * b, 15); },
    // eslint-disable-next-line eqeqeq
...
function format(str, ctx, owner) {
    ...
    subRegex = /\(([^()]+)\)/g, matches = [], floatRegex = /f$/, decRegex = /\.(\d)/, lang = ((_a = owner === null || owner === void 0 ? void 0 : owner.options) === null || _a === void 0 ? void 0 : _a.lang) || defaultOptions.lang, time = (owner === null || owner === void 0 ? void 0 : owner.time) || defaultTime, numberFormatter = (owner === null || owner === void 0 ? void 0 : owner.numberFormatter) || numberFormat.bind(owner);
    /*
